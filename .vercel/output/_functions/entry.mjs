import { B as PrerenderClientAddressNotAvailable, D as MiddlewareNoDataOrNextCalled, E as LocalsReassigned, G as ResponseSentError, J as SessionStorageSaveError, O as MiddlewareNotAResponse, T as LocalsNotAnObject, Y as StaticClientAddressNotAvailable, a as ClientAddressNotAvailable, i as CacheNotEnabled, n as ActionsReturnedInvalidDataError, nt as AstroError, p as ForbiddenRewrite, q as SessionStorageInitError, r as AstroResponseHeadersReassigned, rt as AstroUserError, t as ActionNotFoundError, tt as i18nNoLocaleFoundInPath } from "./chunks/errors-data_BXCH5T4N.mjs";
import { c as matchPattern } from "./chunks/remoteProbe_B3ohb3FH.mjs";
import { $ as createCrossOriginForbiddenResponse, A as generateCspDigest, Ct as joinPaths, E as chunkToString, Et as removeLeadingForwardSlash, F as AstroJSX, G as findRouteToRewrite, H as RedirectSinglePageBuiltModule, I as createVNode, J as isRoute404, K as getOriginPathname, Ot as removeTrailingForwardSlash, Q as NOOP_MIDDLEWARE_FN, R as renderEndpoint, S as renderPage, U as sequence, V as getRouteGenerator, W as copyRequest, X as MultiLevelEncodingError, Y as isRoute500, Z as validateAndDecodePathname, _t as collapseDuplicateSlashes, a as createConsoleLogger, at as ASTRO_GENERATOR, bt as hasFileExtension, c as getParams, ct as appSymbol, d as getFallbackRoute, dt as originPathnameSymbol, et as isForbiddenCrossOriginRequest, f as routeHasHtmlExtension, ft as pipelineSymbol, g as getPattern, gt as collapseDuplicateLeadingSlashes, h as SERVER_ISLAND_COMPONENT, ht as appendForwardSlash, i as PipelineFeatures, it as ASTRO_ERROR_HEADER, k as decodeKey, kt as slash$1, l as getProps, lt as clientAddressSymbol, m as routeIsRedirect, mt as shouldAppendForwardSlash, n as ALL_PIPELINE_FEATURES, nt as BodySizeLimitError, o as AstroIntegrationLogger, ot as REDIRECT_STATUS_CODES, p as routeIsFallback, pt as responseSentSymbol$1, q as setOriginPathname, r as Pipeline, rt as readBodyWithLimit, s as routeComparator, st as REROUTABLE_STATUS_CODES, t as Slots, u as getCustom404Route, ut as fetchStateSymbol, vt as collapseDuplicateTrailingSlashes, w as renderStreaming, wt as prependForwardSlash, xt as isInternalPath, yt as fileExtension } from "./chunks/render_BRuglh_w.mjs";
...
var middlewareSecret = "ce8010aa-4f67-4e10-8809-69e4842efebf";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"PUBLIC_SUPABASE_ANON_KEY": "sb_publishable_KZ0vsyecBmn7kG7UtdJGYA_WcX8aZjv",
			"PUBLIC_SUPABASE_URL": "https://bjotfrlhdixdpkhcnung.supabase.co",
			"SITE": void 0,
			"SSR": true
		}, {
			OS: "Windows_NT",
...
var renderers = [Object.assign({
	...
	"name": "astro:jsx",
	"serverEntrypoint": "file:///C:/Users/Islan/OneDrive/Desktop/PROJETOS%20PESSOAIS/caderno%20do%20aluno/node_modules/@astrojs/mdx/dist/server.js"
}, { ssr: server_default })];
[
	{
		"file": "",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/auth/trocar-senha.ts",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/salas/criar",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/salas\\/criar\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/salas/criar.ts",
			"pathname": "/api/salas/criar",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/usuarios/criar.ts",
			"pathname": "/api/usuarios/criar",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/ds/[materia]/[bimestre]/[semana]",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/ds\\/([^/]+?)\\/([^/]+?)\\/([^/]+?)\\/?$",
			"segments": [
			...
			"component": "src/pages/ds/[materia]/[bimestre]/[semana].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["materia", "bimestre"],
			"component": "src/pages/ds/[materia]/[bimestre]/index.astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["materia"],
			"component": "src/pages/ds/[materia]/index.astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/ds/index.astro",
			"pathname": "/ds",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["materia", "tema"],
			"component": "src/pages/enem/[materia]/[tema].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["materia"],
			"component": "src/pages/enem/[materia]/index.astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/enem/index.astro",
			"pathname": "/enem",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/escolar/[materia]/[bimestre]/[semana]",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/escolar\\/([^/]+?)\\/([^/]+?)\\/([^/]+?)\\/?$",
			"segments": [
			...
			"component": "src/pages/escolar/[materia]/[bimestre]/[semana].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/escolar/[materia]/[bimestre]",
			"isIndex": true,
			"type": "page",
			"pattern": "^\\/escolar\\/([^/]+?)\\/([^/]+?)\\/?$",
			"segments": [
			...
			"params": ["materia", "bimestre"],
			"component": "src/pages/escolar/[materia]/[bimestre]/index.astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["materia"],
			"component": "src/pages/escolar/[materia]/index.astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/escolar/index.astro",
			"pathname": "/escolar",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/trocar-senha.astro",
...
var _page0 = () => import("./chunks/generic_Da5ULPQi.mjs");
var _page1 = () => import("./chunks/index_rMaVaHgF.mjs");
var _page2 = () => import("./chunks/login_DrzJD_c8.mjs");
var _page3 = () => import("./chunks/logout_BckUQHkr.mjs");
var _page4 = () => import("./chunks/trocar-senha_BwIY3L9U.mjs");
var _page5 = () => import("./chunks/criar_BV0hfpFx.mjs");
var _page6 = () => import("./chunks/criar_B2nP_tfz.mjs");
var _page7 = () => import("./chunks/_semana__BN9uKX3L.mjs");
var _page8 = () => import("./chunks/index_COSDNZuT.mjs");
var _page9 = () => import("./chunks/index_DuSK4TK9.mjs");
var _page10 = () => import("./chunks/index_C2Jw_YAo.mjs");
var _page11 = () => import("./chunks/_tema__CiERo8tQ.mjs");
var _page12 = () => import("./chunks/index_7m4Piax6.mjs");
var _page13 = () => import("./chunks/index_zZWoVwQK.mjs");
var _page14 = () => import("./chunks/_semana__C9tbT053.mjs");
var _page15 = () => import("./chunks/index_vufVijL-.mjs");
var _page16 = () => import("./chunks/index_BBzSWGsH.mjs");
var _page17 = () => import("./chunks/index_xg_mFK5Z.mjs");
var _page18 = () => import("./chunks/login_B0cuxuuL.mjs");
var _page19 = () => import("./chunks/trocar-senha_B_Ww7igb.mjs");
var _page20 = () => import("./chunks/index_DDNa41Eq.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/admin/index.astro", _page1],
	["src/pages/api/auth/login.ts", _page2],
	["src/pages/api/auth/logout.ts", _page3],
	["src/pages/api/auth/trocar-senha.ts", _page4],
	["src/pages/api/salas/criar.ts", _page5],
	["src/pages/api/usuarios/criar.ts", _page6],
	["src/pages/ds/[materia]/[bimestre]/[semana].astro", _page7],
	["src/pages/ds/[materia]/[bimestre]/index.astro", _page8],
	["src/pages/ds/[materia]/index.astro", _page9],
	["src/pages/ds/index.astro", _page10],
	["src/pages/enem/[materia]/[tema].astro", _page11],
	["src/pages/enem/[materia]/index.astro", _page12],
	["src/pages/enem/index.astro", _page13],
	["src/pages/escolar/[materia]/[bimestre]/[semana].astro", _page14],
	["src/pages/escolar/[materia]/[bimestre]/index.astro", _page15],
	["src/pages/escolar/[materia]/index.astro", _page16],
	["src/pages/escolar/index.astro", _page17],
	["src/pages/login.astro", _page18],
	["src/pages/trocar-senha.astro", _page19],
	["src/pages/index.astro", _page20]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///C:/Users/Islan/OneDrive/Desktop/PROJETOS%20PESSOAIS/caderno%20do%20aluno/","cacheDir":"file:///C:/Users/Islan/OneDrive/Desktop/PROJETOS%20PESSOAIS/caderno%20do%20aluno/node_modules/.astro/","outDir":"file:///C:/Users/Islan/OneDrive/Desktop/PROJETOS%20PESSOAIS/caderno%20do%20aluno/dist/","srcDir":"file:///C:/Users/Islan/OneDrive/Desktop/PROJETOS%20PESSOAIS/caderno%20do%20aluno/src/","publicDir":"file:///C:/Users/Islan/OneDrive/Desktop/PROJETOS%20PESSOAIS/caderno%20do%20aluno/public/","buildClientDir":"file:///C:/Users/Islan/OneDrive/Desktop/PROJETOS%20PESSOAIS/caderno%20do%20aluno/dist/client/","buildServerDir":"file:///C:/Users/Islan/OneDrive/Desktop/PROJETOS%20PESSOAIS/caderno%20do%20aluno/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n"}],"routeData":{"route":"/admin","isIndex":true,"type":"page","pattern":"^\\/admin\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/index.astro","pathname":"/admin","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/login","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/login\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/login.ts","pathname":"/api/auth/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/logout","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/logout\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"logout","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/logout.ts","pathname":"/api/auth/logout","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/trocar-senha","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/trocar-senha\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"trocar-senha","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/trocar-senha.ts","pathname":"/api/auth/trocar-senha","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/salas/criar","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/salas\\/criar\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"salas","dynamic":false,"spread":false}],[{"content":"criar","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/salas/criar.ts","pathname":"/api/salas/criar","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/usuarios/criar","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/usuarios\\/criar\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"usuarios","dynamic":false,"spread":false}],[{"content":"criar","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/usuarios/criar.ts","pathname":"/api/usuarios/criar","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n.help-btn[data-astro-cid-tvqu44ik]{border:1px solid var(--color-line);background:var(--color-paper);width:1.75rem;height:1.75rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;flex-shrink:0;justify-content:center;align-items:center;font-size:.7rem;font-weight:700;line-height:1;transition:background-color .15s,color .15s,border-color .15s;display:inline-flex}.help-btn[data-astro-cid-tvqu44ik]:hover{background:var(--color-ink);color:var(--color-paper);border-color:var(--color-ink)}.help-dialog[data-astro-cid-tvqu44ik]{background:var(--color-paper);width:calc(100% - 2.5rem);max-width:26rem;color:var(--color-ink);border:none;border-radius:.75rem;padding:1.5rem;position:relative;box-shadow:0 20px 50px #00000040}.help-dialog[data-astro-cid-tvqu44ik]::backdrop{background:color-mix(in srgb, var(--color-ink) 55%, transparent);backdrop-filter:blur(4px)}.help-close[data-astro-cid-tvqu44ik]{width:1.75rem;height:1.75rem;color:var(--color-ink-soft);background:0 0;border:none;border-radius:9999px;font-size:1.1rem;line-height:1;position:absolute;top:.6rem;right:.75rem}.help-close[data-astro-cid-tvqu44ik]:hover{color:var(--color-ink)}\n.res-card[data-astro-cid-3i6npqkg]{border:2px solid var(--color-paper-dark);background:#ffffffa6;border-radius:.6rem;align-items:flex-start;gap:.9rem;padding:1rem 1.1rem;text-decoration:none;transition:transform .15s,border-color .15s,box-shadow .15s;display:flex}a[data-astro-cid-3i6npqkg].res-card:hover{border-color:var(--res-accent);transform:translateY(-3px);box-shadow:0 8px 18px #1f2a441f}.res-icon[data-astro-cid-3i6npqkg]{background:var(--res-soft);border-radius:.55rem;flex-shrink:0;place-items:center;width:2.75rem;height:2.75rem;font-size:1.3rem;display:grid}.res-body[data-astro-cid-3i6npqkg]{flex-direction:column;min-width:0;display:flex}.res-kicker[data-astro-cid-3i6npqkg]{font-family:var(--font-mono);text-transform:uppercase;letter-spacing:.08em;color:var(--res-accent);margin-bottom:.3rem;font-size:.65rem;font-weight:600}.res-title[data-astro-cid-3i6npqkg]{font-family:var(--font-body);color:var(--color-ink);overflow-wrap:break-word;margin-bottom:.5rem;font-size:.9rem;line-height:1.45}.res-note[data-astro-cid-3i6npqkg]{font-family:var(--font-body);color:var(--color-ink-soft);font-size:.8rem;line-height:1.5}.res-cta[data-astro-cid-3i6npqkg]{font-family:var(--font-display);color:var(--res-accent);align-items:center;gap:.3rem;margin-top:auto;font-size:.8rem;font-weight:700;display:inline-flex}.res-arrow[data-astro-cid-3i6npqkg]{transition:transform .15s;display:inline-block}a[data-astro-cid-3i6npqkg].res-card:hover .res-arrow[data-astro-cid-3i6npqkg]{transform:translate(4px)}.res-rows[data-astro-cid-3i6npqkg]{flex-direction:column;gap:.4rem;display:flex}.res-row[data-astro-cid-3i6npqkg]{font-family:var(--font-body);color:var(--color-ink);overflow-wrap:break-word;font-size:.82rem;line-height:1.45}.res-row[data-astro-cid-3i6npqkg] b[data-astro-cid-3i6npqkg]{font-weight:600}@media (prefers-reduced-motion:reduce){.res-card[data-astro-cid-3i6npqkg],.res-arrow[data-astro-cid-3i6npqkg]{transition:none}}\n"}],"routeData":{"route":"/ds/[materia]/[bimestre]/[semana]","isIndex":false,"type":"page","pattern":"^\\/ds\\/([^/]+?)\\/([^/]+?)\\/([^/]+?)\\/?$","segments":[[{"content":"ds","dynamic":false,"spread":false}],[{"content":"materia","dynamic":true,"spread":false}],[{"content":"bimestre","dynamic":true,"spread":false}],[{"content":"semana","dynamic":true,"spread":false}]],"params":["materia","bimestre","semana"],"component":"src/pages/ds/[materia]/[bimestre]/[semana].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n"}],"routeData":{"route":"/ds/[materia]/[bimestre]","isIndex":true,"type":"page","pattern":"^\\/ds\\/([^/]+?)\\/([^/]+?)\\/?$","segments":[[{"content":"ds","dynamic":false,"spread":false}],[{"content":"materia","dynamic":true,"spread":false}],[{"content":"bimestre","dynamic":true,"spread":false}]],"params":["materia","bimestre"],"component":"src/pages/ds/[materia]/[bimestre]/index.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n"}],"routeData":{"route":"/ds/[materia]","isIndex":true,"type":"page","pattern":"^\\/ds\\/([^/]+?)\\/?$","segments":[[{"content":"ds","dynamic":false,"spread":false}],[{"content":"materia","dynamic":true,"spread":false}]],"params":["materia"],"component":"src/pages/ds/[materia]/index.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".help-btn[data-astro-cid-tvqu44ik]{border:1px solid var(--color-line);background:var(--color-paper);width:1.75rem;height:1.75rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;flex-shrink:0;justify-content:center;align-items:center;font-size:.7rem;font-weight:700;line-height:1;transition:background-color .15s,color .15s,border-color .15s;display:inline-flex}.help-btn[data-astro-cid-tvqu44ik]:hover{background:var(--color-ink);color:var(--color-paper);border-color:var(--color-ink)}.help-dialog[data-astro-cid-tvqu44ik]{background:var(--color-paper);width:calc(100% - 2.5rem);max-width:26rem;color:var(--color-ink);border:none;border-radius:.75rem;padding:1.5rem;position:relative;box-shadow:0 20px 50px #00000040}.help-dialog[data-astro-cid-tvqu44ik]::backdrop{background:color-mix(in srgb, var(--color-ink) 55%, transparent);backdrop-filter:blur(4px)}.help-close[data-astro-cid-tvqu44ik]{width:1.75rem;height:1.75rem;color:var(--color-ink-soft);background:0 0;border:none;border-radius:9999px;font-size:1.1rem;line-height:1;position:absolute;top:.6rem;right:.75rem}.help-close[data-astro-cid-tvqu44ik]:hover{color:var(--color-ink)}\n.tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n"}],"routeData":{"route":"/ds","isIndex":true,"type":"page","pattern":"^\\/ds\\/?$","segments":[[{"content":"ds","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/ds/index.astro","pathname":"/ds","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n.help-btn[data-astro-cid-tvqu44ik]{border:1px solid var(--color-line);background:var(--color-paper);width:1.75rem;height:1.75rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;flex-shrink:0;justify-content:center;align-items:center;font-size:.7rem;font-weight:700;line-height:1;transition:background-color .15s,color .15s,border-color .15s;display:inline-flex}.help-btn[data-astro-cid-tvqu44ik]:hover{background:var(--color-ink);color:var(--color-paper);border-color:var(--color-ink)}.help-dialog[data-astro-cid-tvqu44ik]{background:var(--color-paper);width:calc(100% - 2.5rem);max-width:26rem;color:var(--color-ink);border:none;border-radius:.75rem;padding:1.5rem;position:relative;box-shadow:0 20px 50px #00000040}.help-dialog[data-astro-cid-tvqu44ik]::backdrop{background:color-mix(in srgb, var(--color-ink) 55%, transparent);backdrop-filter:blur(4px)}.help-close[data-astro-cid-tvqu44ik]{width:1.75rem;height:1.75rem;color:var(--color-ink-soft);background:0 0;border:none;border-radius:9999px;font-size:1.1rem;line-height:1;position:absolute;top:.6rem;right:.75rem}.help-close[data-astro-cid-tvqu44ik]:hover{color:var(--color-ink)}\n.res-card[data-astro-cid-3i6npqkg]{border:2px solid var(--color-paper-dark);background:#ffffffa6;border-radius:.6rem;align-items:flex-start;gap:.9rem;padding:1rem 1.1rem;text-decoration:none;transition:transform .15s,border-color .15s,box-shadow .15s;display:flex}a[data-astro-cid-3i6npqkg].res-card:hover{border-color:var(--res-accent);transform:translateY(-3px);box-shadow:0 8px 18px #1f2a441f}.res-icon[data-astro-cid-3i6npqkg]{background:var(--res-soft);border-radius:.55rem;flex-shrink:0;place-items:center;width:2.75rem;height:2.75rem;font-size:1.3rem;display:grid}.res-body[data-astro-cid-3i6npqkg]{flex-direction:column;min-width:0;display:flex}.res-kicker[data-astro-cid-3i6npqkg]{font-family:var(--font-mono);text-transform:uppercase;letter-spacing:.08em;color:var(--res-accent);margin-bottom:.3rem;font-size:.65rem;font-weight:600}.res-title[data-astro-cid-3i6npqkg]{font-family:var(--font-body);color:var(--color-ink);overflow-wrap:break-word;margin-bottom:.5rem;font-size:.9rem;line-height:1.45}.res-note[data-astro-cid-3i6npqkg]{font-family:var(--font-body);color:var(--color-ink-soft);font-size:.8rem;line-height:1.5}.res-cta[data-astro-cid-3i6npqkg]{font-family:var(--font-display);color:var(--res-accent);align-items:center;gap:.3rem;margin-top:auto;font-size:.8rem;font-weight:700;display:inline-flex}.res-arrow[data-astro-cid-3i6npqkg]{transition:transform .15s;display:inline-block}a[data-astro-cid-3i6npqkg].res-card:hover .res-arrow[data-astro-cid-3i6npqkg]{transform:translate(4px)}.res-rows[data-astro-cid-3i6npqkg]{flex-direction:column;gap:.4rem;display:flex}.res-row[data-astro-cid-3i6npqkg]{font-family:var(--font-body);color:var(--color-ink);overflow-wrap:break-word;font-size:.82rem;line-height:1.45}.res-row[data-astro-cid-3i6npqkg] b[data-astro-cid-3i6npqkg]{font-weight:600}@media (prefers-reduced-motion:reduce){.res-card[data-astro-cid-3i6npqkg],.res-arrow[data-astro-cid-3i6npqkg]{transition:none}}\n"}],"routeData":{"route":"/enem/[materia]/[tema]","isIndex":false,"type":"page","pattern":"^\\/enem\\/([^/]+?)\\/([^/]+?)\\/?$","segments":[[{"content":"enem","dynamic":false,"spread":false}],[{"content":"materia","dynamic":true,"spread":false}],[{"content":"tema","dynamic":true,"spread":false}]],"params":["materia","tema"],"component":"src/pages/enem/[materia]/[tema].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n"}],"routeData":{"route":"/enem/[materia]","isIndex":true,"type":"page","pattern":"^\\/enem\\/([^/]+?)\\/?$","segments":[[{"content":"enem","dynamic":false,"spread":false}],[{"content":"materia","dynamic":true,"spread":false}]],"params":["materia"],"component":"src/pages/enem/[materia]/index.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".help-btn[data-astro-cid-tvqu44ik]{border:1px solid var(--color-line);background:var(--color-paper);width:1.75rem;height:1.75rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;flex-shrink:0;justify-content:center;align-items:center;font-size:.7rem;font-weight:700;line-height:1;transition:background-color .15s,color .15s,border-color .15s;display:inline-flex}.help-btn[data-astro-cid-tvqu44ik]:hover{background:var(--color-ink);color:var(--color-paper);border-color:var(--color-ink)}.help-dialog[data-astro-cid-tvqu44ik]{background:var(--color-paper);width:calc(100% - 2.5rem);max-width:26rem;color:var(--color-ink);border:none;border-radius:.75rem;padding:1.5rem;position:relative;box-shadow:0 20px 50px #00000040}.help-dialog[data-astro-cid-tvqu44ik]::backdrop{background:color-mix(in srgb, var(--color-ink) 55%, transparent);backdrop-filter:blur(4px)}.help-close[data-astro-cid-tvqu44ik]{width:1.75rem;height:1.75rem;color:var(--color-ink-soft);background:0 0;border:none;border-radius:9999px;font-size:1.1rem;line-height:1;position:absolute;top:.6rem;right:.75rem}.help-close[data-astro-cid-tvqu44ik]:hover{color:var(--color-ink)}\n.tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n"}],"routeData":{"route":"/enem","isIndex":true,"type":"page","pattern":"^\\/enem\\/?$","segments":[[{"content":"enem","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/enem/index.astro","pathname":"/enem","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n.help-btn[data-astro-cid-tvqu44ik]{border:1px solid var(--color-line);background:var(--color-paper);width:1.75rem;height:1.75rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;flex-shrink:0;justify-content:center;align-items:center;font-size:.7rem;font-weight:700;line-height:1;transition:background-color .15s,color .15s,border-color .15s;display:inline-flex}.help-btn[data-astro-cid-tvqu44ik]:hover{background:var(--color-ink);color:var(--color-paper);border-color:var(--color-ink)}.help-dialog[data-astro-cid-tvqu44ik]{background:var(--color-paper);width:calc(100% - 2.5rem);max-width:26rem;color:var(--color-ink);border:none;border-radius:.75rem;padding:1.5rem;position:relative;box-shadow:0 20px 50px #00000040}.help-dialog[data-astro-cid-tvqu44ik]::backdrop{background:color-mix(in srgb, var(--color-ink) 55%, transparent);backdrop-filter:blur(4px)}.help-close[data-astro-cid-tvqu44ik]{width:1.75rem;height:1.75rem;color:var(--color-ink-soft);background:0 0;border:none;border-radius:9999px;font-size:1.1rem;line-height:1;position:absolute;top:.6rem;right:.75rem}.help-close[data-astro-cid-tvqu44ik]:hover{color:var(--color-ink)}\n.res-card[data-astro-cid-3i6npqkg]{border:2px solid var(--color-paper-dark);background:#ffffffa6;border-radius:.6rem;align-items:flex-start;gap:.9rem;padding:1rem 1.1rem;text-decoration:none;transition:transform .15s,border-color .15s,box-shadow .15s;display:flex}a[data-astro-cid-3i6npqkg].res-card:hover{border-color:var(--res-accent);transform:translateY(-3px);box-shadow:0 8px 18px #1f2a441f}.res-icon[data-astro-cid-3i6npqkg]{background:var(--res-soft);border-radius:.55rem;flex-shrink:0;place-items:center;width:2.75rem;height:2.75rem;font-size:1.3rem;display:grid}.res-body[data-astro-cid-3i6npqkg]{flex-direction:column;min-width:0;display:flex}.res-kicker[data-astro-cid-3i6npqkg]{font-family:var(--font-mono);text-transform:uppercase;letter-spacing:.08em;color:var(--res-accent);margin-bottom:.3rem;font-size:.65rem;font-weight:600}.res-title[data-astro-cid-3i6npqkg]{font-family:var(--font-body);color:var(--color-ink);overflow-wrap:break-word;margin-bottom:.5rem;font-size:.9rem;line-height:1.45}.res-note[data-astro-cid-3i6npqkg]{font-family:var(--font-body);color:var(--color-ink-soft);font-size:.8rem;line-height:1.5}.res-cta[data-astro-cid-3i6npqkg]{font-family:var(--font-display);color:var(--res-accent);align-items:center;gap:.3rem;margin-top:auto;font-size:.8rem;font-weight:700;display:inline-flex}.res-arrow[data-astro-cid-3i6npqkg]{transition:transform .15s;display:inline-block}a[data-astro-cid-3i6npqkg].res-card:hover .res-arrow[data-astro-cid-3i6npqkg]{transform:translate(4px)}.res-rows[data-astro-cid-3i6npqkg]{flex-direction:column;gap:.4rem;display:flex}.res-row[data-astro-cid-3i6npqkg]{font-family:var(--font-body);color:var(--color-ink);overflow-wrap:break-word;font-size:.82rem;line-height:1.45}.res-row[data-astro-cid-3i6npqkg] b[data-astro-cid-3i6npqkg]{font-weight:600}@media (prefers-reduced-motion:reduce){.res-card[data-astro-cid-3i6npqkg],.res-arrow[data-astro-cid-3i6npqkg]{transition:none}}\n"}],"routeData":{"route":"/escolar/[materia]/[bimestre]/[semana]","isIndex":false,"type":"page","pattern":"^\\/escolar\\/([^/]+?)\\/([^/]+?)\\/([^/]+?)\\/?$","segments":[[{"content":"escolar","dynamic":false,"spread":false}],[{"content":"materia","dynamic":true,"spread":false}],[{"content":"bimestre","dynamic":true,"spread":false}],[{"content":"semana","dynamic":true,"spread":false}]],"params":["materia","bimestre","semana"],"component":"src/pages/escolar/[materia]/[bimestre]/[semana].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n"}],"routeData":{"route":"/escolar/[materia]/[bimestre]","isIndex":true,"type":"page","pattern":"^\\/escolar\\/([^/]+?)\\/([^/]+?)\\/?$","segments":[[{"content":"escolar","dynamic":false,"spread":false}],[{"content":"materia","dynamic":true,"spread":false}],[{"content":"bimestre","dynamic":true,"spread":false}]],"params":["materia","bimestre"],"component":"src/pages/escolar/[materia]/[bimestre]/index.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n"}],"routeData":{"route":"/escolar/[materia]","isIndex":true,"type":"page","pattern":"^\\/escolar\\/([^/]+?)\\/?$","segments":[[{"content":"escolar","dynamic":false,"spread":false}],[{"content":"materia","dynamic":true,"spread":false}]],"params":["materia"],"component":"src/pages/escolar/[materia]/index.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".help-btn[data-astro-cid-tvqu44ik]{border:1px solid var(--color-line);background:var(--color-paper);width:1.75rem;height:1.75rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;flex-shrink:0;justify-content:center;align-items:center;font-size:.7rem;font-weight:700;line-height:1;transition:background-color .15s,color .15s,border-color .15s;display:inline-flex}.help-btn[data-astro-cid-tvqu44ik]:hover{background:var(--color-ink);color:var(--color-paper);border-color:var(--color-ink)}.help-dialog[data-astro-cid-tvqu44ik]{background:var(--color-paper);width:calc(100% - 2.5rem);max-width:26rem;color:var(--color-ink);border:none;border-radius:.75rem;padding:1.5rem;position:relative;box-shadow:0 20px 50px #00000040}.help-dialog[data-astro-cid-tvqu44ik]::backdrop{background:color-mix(in srgb, var(--color-ink) 55%, transparent);backdrop-filter:blur(4px)}.help-close[data-astro-cid-tvqu44ik]{width:1.75rem;height:1.75rem;color:var(--color-ink-soft);background:0 0;border:none;border-radius:9999px;font-size:1.1rem;line-height:1;position:absolute;top:.6rem;right:.75rem}.help-close[data-astro-cid-tvqu44ik]:hover{color:var(--color-ink)}\n.tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n"}],"routeData":{"route":"/escolar","isIndex":true,"type":"page","pattern":"^\\/escolar\\/?$","segments":[[{"content":"escolar","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/escolar/index.astro","pathname":"/escolar","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".paper-card[data-astro-cid-sjqh5bze]{background:color-mix(in srgb, var(--color-paper) 92%, white);border:2px solid var(--color-line);box-shadow:0 10px 30px #1f2a4414}\n"}],"routeData":{"route":"/login","isIndex":false,"type":"page","pattern":"^\\/login\\/?$","segments":[[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/login.astro","pathname":"/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n"}],"routeData":{"route":"/trocar-senha","isIndex":false,"type":"page","pattern":"^\\/trocar-senha\\/?$","segments":[[{"content":"trocar-senha","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/trocar-senha.astro","pathname":"/trocar-senha","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.a9zKlqTW.css"},{"type":"inline","content":".help-btn[data-astro-cid-tvqu44ik]{border:1px solid var(--color-line);background:var(--color-paper);width:1.75rem;height:1.75rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;flex-shrink:0;justify-content:center;align-items:center;font-size:.7rem;font-weight:700;line-height:1;transition:background-color .15s,color .15s,border-color .15s;display:inline-flex}.help-btn[data-astro-cid-tvqu44ik]:hover{background:var(--color-ink);color:var(--color-paper);border-color:var(--color-ink)}.help-dialog[data-astro-cid-tvqu44ik]{background:var(--color-paper);width:calc(100% - 2.5rem);max-width:26rem;color:var(--color-ink);border:none;border-radius:.75rem;padding:1.5rem;position:relative;box-shadow:0 20px 50px #00000040}.help-dialog[data-astro-cid-tvqu44ik]::backdrop{background:color-mix(in srgb, var(--color-ink) 55%, transparent);backdrop-filter:blur(4px)}.help-close[data-astro-cid-tvqu44ik]{width:1.75rem;height:1.75rem;color:var(--color-ink-soft);background:0 0;border:none;border-radius:9999px;font-size:1.1rem;line-height:1;position:absolute;top:.6rem;right:.75rem}.help-close[data-astro-cid-tvqu44ik]:hover{color:var(--color-ink)}\n.tab[data-astro-cid-bxhs5b4m]{background:var(--tab-soft);color:var(--tab-color);border:2px solid var(--tab-color);opacity:.7;border-bottom:none;margin-top:10px;transform:translateY(6px)}.tab[data-astro-cid-bxhs5b4m]:hover{opacity:1;transform:translateY(3px)}.tab[data-astro-cid-bxhs5b4m][data-active=true]{opacity:1;margin-top:0;transform:none}@media (prefers-reduced-motion:reduce){.tab[data-astro-cid-bxhs5b4m]{transition:none}}.hist-btn[data-astro-cid-hkbrpulz]{border:1px solid var(--color-line);background:var(--color-paper);width:2.25rem;height:2.25rem;color:var(--color-ink-soft);font-family:var(--font-mono);border-radius:9999px;justify-content:center;align-items:center;font-size:.75rem;transition:background-color .15s,color .15s;display:inline-flex}.hist-btn[data-astro-cid-hkbrpulz]:hover{background:var(--color-paper-dark);color:var(--color-ink)}.paper-sheet[data-astro-cid-hkbrpulz]{z-index:5;border-style:solid;border-width:2px;border-radius:0 .6rem .6rem 0;position:relative}.paper-sheet[data-astro-cid-hkbrpulz]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle 5px at 9px 20px, var(--color-paper) 99%, transparent 100%), radial-gradient(circle 6px at 9px 18.5px, #1f2a4461 99%, transparent 100%), radial-gradient(circle 6px at 9px 21.5px, #ffffffd9 99%, transparent 100%);background-repeat:no-repeat space;background-size:18px 40px;width:18px;position:absolute;top:12px;bottom:12px;left:8px}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/ds/[materia]/[bimestre]/[semana].astro",{"propagation":"in-tree","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/enem/[materia]/[tema].astro",{"propagation":"in-tree","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/escolar/[materia]/[bimestre]/[semana].astro",{"propagation":"in-tree","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/admin/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/ds/[materia]/[bimestre]/index.astro",{"propagation":"in-tree","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/ds/[materia]/index.astro",{"propagation":"in-tree","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/ds/index.astro",{"propagation":"in-tree","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/enem/[materia]/index.astro",{"propagation":"in-tree","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/enem/index.astro",{"propagation":"in-tree","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/escolar/[materia]/[bimestre]/index.astro",{"propagation":"in-tree","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/escolar/[materia]/index.astro",{"propagation":"in-tree","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/escolar/index.astro",{"propagation":"in-tree","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/trocar-senha.astro",{"propagation":"none","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/login.astro",{"propagation":"none","containsHead":true}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/enem/fisica/cinematica.mdx?astroPropagatedAssets",{"propagation":"in-tree","containsHead":false}],["C:\\Users\\Islan\\OneDrive\\Desktop\\PROJETOS PESSOAIS\\caderno do aluno\\.astro\\content-modules.mjs",{"propagation":"in-tree","containsHead":false}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/node_modules/astro/dist/content/runtime.js",{"propagation":"in-tree","containsHead":false}],["\u0000astro:content",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/ds/[materia]/[bimestre]/[semana]@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:pages",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:manifest",{"propagation":"in-tree","containsHead":false}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/node_modules/astro/dist/core/app/entrypoints/virtual/prod.js",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:app",{"propagation":"in-tree","containsHead":false}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/node_modules/astro/dist/core/app/entrypoints/virtual/index.js",{"propagation":"in-tree","containsHead":false}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/node_modules/@astrojs/vercel/dist/serverless/entrypoint.js",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/ds/[materia]/[bimestre]/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/ds/[materia]/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/ds/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/enem/[materia]/[tema]@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/enem/[materia]/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/enem/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/escolar/[materia]/[bimestre]/[semana]@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/escolar/[materia]/[bimestre]/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/escolar/[materia]/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/escolar/index@_@astro",{"propagation":"in-tree","containsHead":false}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/enem/matematica/geometria-plana.mdx?astroPropagatedAssets",{"propagation":"in-tree","containsHead":false}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/escolar/historia/1-bimestre/semana-01-chegada-portugueses.mdx?astroPropagatedAssets",{"propagation":"in-tree","containsHead":false}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/escolar/matematica/1-bimestre/semana-01-funcoes.mdx?astroPropagatedAssets",{"propagation":"in-tree","containsHead":false}],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/ds/logica-de-programacao/1-bimestre/semana-01-introducao.mdx?astroPropagatedAssets",{"propagation":"in-tree","containsHead":false}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.BKWlhDRi.mjs","\u0000virtual:astro:middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000astro:data-layer-content":"chunks/_astro_data-layer-content_xaXbALvP.mjs","\u0000virtual:astro:page:src/pages/ds/[materia]/[bimestre]/[semana]@_@astro":"chunks/_semana__BN9uKX3L.mjs","\u0000virtual:astro:page:src/pages/escolar/[materia]/[bimestre]/[semana]@_@astro":"chunks/_semana__C9tbT053.mjs","\u0000virtual:astro:page:src/pages/enem/[materia]/[tema]@_@astro":"chunks/_tema__CiERo8tQ.mjs","\u0000virtual:astro:get-image":"chunks/_virtual_astro_get-image_C0I-Og0L.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/enem/fisica/cinematica.mdx":"chunks/cinematica_CLgP50SD.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/enem/fisica/cinematica.mdx?astroPropagatedAssets":"chunks/cinematica_DGPf6_MO.mjs","C:\\Users\\Islan\\OneDrive\\Desktop\\PROJETOS PESSOAIS\\caderno do aluno\\.astro\\content-assets.mjs":"chunks/content-assets_BNW1matP.mjs","C:\\Users\\Islan\\OneDrive\\Desktop\\PROJETOS PESSOAIS\\caderno do aluno\\.astro\\content-modules.mjs":"chunks/content-modules_Fw0qB4NJ.mjs","\u0000virtual:astro:page:src/pages/api/usuarios/criar@_@ts":"chunks/criar_B2nP_tfz.mjs","\u0000virtual:astro:page:src/pages/api/salas/criar@_@ts":"chunks/criar_BV0hfpFx.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_Da5ULPQi.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/enem/matematica/geometria-plana.mdx?astroPropagatedAssets":"chunks/geometria-plana_B3CuYV1n.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/enem/matematica/geometria-plana.mdx":"chunks/geometria-plana_DjoO7a4D.mjs","\u0000virtual:astro:page:src/pages/enem/[materia]/index@_@astro":"chunks/index_7m4Piax6.mjs","\u0000virtual:astro:page:src/pages/escolar/[materia]/index@_@astro":"chunks/index_BBzSWGsH.mjs","\u0000virtual:astro:page:src/pages/ds/index@_@astro":"chunks/index_C2Jw_YAo.mjs","\u0000virtual:astro:page:src/pages/ds/[materia]/[bimestre]/index@_@astro":"chunks/index_COSDNZuT.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_DDNa41Eq.mjs","\u0000virtual:astro:page:src/pages/ds/[materia]/index@_@astro":"chunks/index_DuSK4TK9.mjs","\u0000virtual:astro:page:src/pages/admin/index@_@astro":"chunks/index_rMaVaHgF.mjs","\u0000virtual:astro:page:src/pages/escolar/[materia]/[bimestre]/index@_@astro":"chunks/index_vufVijL-.mjs","\u0000virtual:astro:page:src/pages/escolar/index@_@astro":"chunks/index_xg_mFK5Z.mjs","\u0000virtual:astro:page:src/pages/enem/index@_@astro":"chunks/index_zZWoVwQK.mjs","\u0000virtual:astro:page:src/pages/login@_@astro":"chunks/login_B0cuxuuL.mjs","\u0000virtual:astro:page:src/pages/api/auth/login@_@ts":"chunks/login_DrzJD_c8.mjs","\u0000virtual:astro:page:src/pages/api/auth/logout@_@ts":"chunks/logout_BckUQHkr.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/escolar/historia/1-bimestre/semana-01-chegada-portugueses.mdx":"chunks/semana-01-chegada-portugueses_B9TIHZBi.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/escolar/historia/1-bimestre/semana-01-chegada-portugueses.mdx?astroPropagatedAssets":"chunks/semana-01-chegada-portugueses_CBGPkv_8.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/escolar/matematica/1-bimestre/semana-01-funcoes.mdx?astroPropagatedAssets":"chunks/semana-01-funcoes_36n4SzZp.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/escolar/matematica/1-bimestre/semana-01-funcoes.mdx":"chunks/semana-01-funcoes_t2LXeC2c.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/ds/logica-de-programacao/1-bimestre/semana-01-introducao.mdx?astroPropagatedAssets":"chunks/semana-01-introducao_DO8y00vH.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/content/ds/logica-de-programacao/1-bimestre/semana-01-introducao.mdx":"chunks/semana-01-introducao_zRBMW4fy.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_B0PhdFrf.mjs","\u0000virtual:astro:page:src/pages/trocar-senha@_@astro":"chunks/trocar-senha_B_Ww7igb.mjs","\u0000virtual:astro:page:src/pages/api/auth/trocar-senha@_@ts":"chunks/trocar-senha_BwIY3L9U.mjs","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/layouts/Base.astro?astro&type=script&index=0&lang.ts":"_astro/Base.astro_astro_type_script_index_0_lang.DMgscRGC.js","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/components/Comentarios.jsx":"_astro/Comentarios.C2LD9VVm.js","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/components/Quiz.jsx":"_astro/Quiz.BmhjGWaX.js","@astrojs/react/client.js":"_astro/client._Mmw9A-F.js","C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/admin/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.Bayt9k4G.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/layouts/Base.astro?astro&type=script&index=0&lang.ts","document.addEventListener(`click`,e=>{let t=e.target;if(!(t instanceof Element))return;let n=t.closest(`[data-help-target]`);if(n){let e=n.getAttribute(`data-help-target`),t=e?document.getElementById(e):null;t instanceof HTMLDialogElement&&t.showModal();return}let r=t.closest(`[data-help-close]`);if(r){let e=r.closest(`dialog`);e instanceof HTMLDialogElement&&e.close();return}t.tagName===`DIALOG`&&t.close()});"],["C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/admin/index.astro?astro&type=script&index=0&lang.ts","async function e(e,t,n){let r=Object.fromEntries(new FormData(e).entries());n.textContent=`Enviando…`,n.className=`font-body text-xs leading-relaxed text-ink-soft`;try{let e=await fetch(t,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify(r)}),n=await e.json();if(!e.ok)throw Error(n.error??`Falha desconhecida`);return n}catch(e){return n.textContent=`✕ `+(e instanceof Error?e.message:`Erro inesperado`),n.className=`font-body text-xs leading-relaxed text-enem`,null}}var t=document.getElementById(`form-usuario`);t?.addEventListener(`submit`,async n=>{n.preventDefault();let r=document.getElementById(`resultado-usuario`),i=await e(t,`/api/usuarios/criar`,r);i&&(r.innerHTML=`✓ Conta <b>@${i.username}</b> criada (${i.papel}). Senha padrão: <code>${i.senhaPadrao}</code> — anote e entregue!`,r.className=`font-body text-xs leading-relaxed text-ds`,t.reset())});var n=document.getElementById(`form-sala`);n?.addEventListener(`submit`,async t=>{t.preventDefault();let r=document.getElementById(`resultado-sala`);await e(n,`/api/salas/criar`,r)&&(r.textContent=`✓ Sala criada! Recarregue a página pra vê-la nas listas.`,r.className=`font-body text-xs leading-relaxed text-ds`,n.reset())});"]],"assets":["/favicon.ico","/favicon.svg","/_astro/client._Mmw9A-F.js","/_astro/Comentarios.C2LD9VVm.js","/_astro/jsx-runtime.skGABptv.js","/_astro/Quiz.BmhjGWaX.js","/_astro/react.C1VktWof.js","/_astro/global.a9zKlqTW.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"14wVJcfIBIbcuDkDi2UpR/E+Zu/S0V5DxW5I3g9yxXQ=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
