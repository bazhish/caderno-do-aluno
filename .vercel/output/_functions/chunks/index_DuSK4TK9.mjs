...
//#region src/pages/ds/[materia]/index.astro
...
var $$Index = createComponent(async ($$result, $$props, $$slots) => {
	...
	if (!materia) return Astro.redirect(u("/ds"));
	...
	}, { "default": ($$result) => renderTemplate`${maybeRenderHead($$result)}<nav class="font-mono text-xs text-ink-soft mb-4"><a${addAttribute(u("/ds"), "href")} class="hover:text-ink underline underline-offset-2">DS</a><span> / </span><span class="text-ink">${materia.label}</span></nav><h1 class="font-display text-3xl md:text-4xl font-bold text-ink mb-8">${materia.label}</h1><ul class="flex flex-col gap-3 list-none p-0 m-0">${bimestres.map((b) => renderTemplate`<li><a${addAttribute(u(`/ds/${materiaSlug}/${b.slug}/`), "href")} class="flex items-center justify-between gap-4 rounded-md border border-paper-dark px-5 py-4 hover:border-ds transition-colors bg-white/50"><span class="font-body text-ink font-medium">${b.label}</span><span class="font-mono text-xs text-ink-soft shrink-0">${b.semanas.length} ${b.semanas.length === 1 ? "semana" : "semanas"} →</span></a></li>`)}</ul>` })}`;
}, "C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/ds/[materia]/index.astro", void 0);
var $$file = "C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/ds/[materia]/index.astro";
var $$url = "/ds/[materia]";
//#endregion
//#region \0virtual:astro:page:src/pages/ds/[materia]/index@_@astro
