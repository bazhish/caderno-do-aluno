...
//#region src/pages/ds/[materia]/[bimestre]/index.astro
...
var $$Index = createComponent(async ($$result, $$props, $$slots) => {
	...
	}, { "default": ($$result) => renderTemplate`${maybeRenderHead($$result)}<nav class="font-mono text-xs text-ink-soft mb-4 flex flex-wrap gap-1"><a${addAttribute(u("/ds"), "href")} class="hover:text-ink underline underline-offset-2">DS</a><span>/</span><a${addAttribute(u(`/ds/${materia}/`), "href")} class="hover:text-ink underline underline-offset-2">${materiaLabel}</a><span>/</span><span class="text-ink">${bimestreLabel}</span></nav><h1 class="font-display text-3xl md:text-4xl font-bold text-ink mb-8">${bimestreLabel}</h1><ul class="flex flex-col gap-3 list-none p-0 m-0">${semanas.map((s) => renderTemplate`<li><a${addAttribute(u(`/ds/${materia}/${bimestre}/${splitSlug(s.id)[2]}/`), "href")} class="flex items-center justify-between gap-4 rounded-md border border-paper-dark px-5 py-4 hover:border-ds transition-colors bg-white/50"><span class="font-mono text-xs text-ink-soft shrink-0">${semanaLabel(splitSlug(s.id)[2])}</span><span class="font-body text-ink font-medium flex-1 text-right">${s.data.title}</span></a></li>`)}</ul>` })}`;
}, "C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/ds/[materia]/[bimestre]/index.astro", void 0);
var $$file = "C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/ds/[materia]/[bimestre]/index.astro";
var $$url = "/ds/[materia]/[bimestre]";
//#endregion
//#region \0virtual:astro:page:src/pages/ds/[materia]/[bimestre]/index@_@astro
