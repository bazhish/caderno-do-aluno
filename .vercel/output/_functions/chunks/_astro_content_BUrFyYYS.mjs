import { Q as UnknownContentCollectionError, U as RenderUndefinedEntryError, nt as AstroError } from "./errors-data_BXCH5T4N.mjs";
import { A as generateCspDigest, B as createComponent, C as renderComponent, L as unescapeHTML, O as renderTemplate, P as createHeadAndContent, St as isRemotePath, Tt as removeBase, b as renderUniqueStylesheet, v as spreadAttributes, wt as prependForwardSlash, y as renderScriptElement } from "./render_BRuglh_w.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_xaXbALvP.mjs");
...
async function updateImageReferencesInBody(html, fileName) {
	...
	const { getImage } = await import("./_virtual_astro_get-image_C0I-Og0L.mjs");
...
async function renderEntry(entry) {
	...
	if (entry.deferredRender) try {
		const { default: contentModules } = await import("./content-modules_Fw0qB4NJ.mjs");
