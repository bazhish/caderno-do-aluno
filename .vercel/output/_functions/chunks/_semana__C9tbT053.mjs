...
//#region src/pages/escolar/[materia]/[bimestre]/[semana].astro
...
var $$Semana = createComponent(async ($$result, $$props, $$slots) => {
	...
	const entry = (await getCollection("escolar")).find((e) => e.id === `${materia}/${bimestre}/${semana}`);
	...
	return renderTemplate`${renderComponent($$result, "Tema", $$Tema, {
		...
		"breadcrumb": [
			...
			{
				label: subjectLabel,
				href: u(`/escolar/${materia}/`)
			},
			{
				label: bimestreLabel(bimestre),
				href: u(`/escolar/${materia}/${bimestre}/`)
			},
			{ label: entry.data.title }
		]
	}, { "default": ($$result) => renderTemplate`${renderComponent($$result, "Content", Content, {})}` })}`;
}, "C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/escolar/[materia]/[bimestre]/[semana].astro", void 0);
var $$file = "C:/Users/Islan/OneDrive/Desktop/PROJETOS PESSOAIS/caderno do aluno/src/pages/escolar/[materia]/[bimestre]/[semana].astro";
var $$url = "/escolar/[materia]/[bimestre]/[semana]";
//#endregion
//#region \0virtual:astro:page:src/pages/escolar/[materia]/[bimestre]/[semana]@_@astro
